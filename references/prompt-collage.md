...
仅在已锁定“手绘知识拼贴”时读取。每张图单独生成，不要拼接多张成图。
...
Constraints:
One image serves one central thesis. Preserve generous white space. Make the center visible within one second and the satellites readable on a second glance. Keep labels short; reserve blank label areas rather than attempting long or exact Chinese text. Do not add a title in the top-left corner. Do not copy prior examples, logos, watermarks, people, or compositions. It must feel sparse, flat, and editorial—not like a rich product sketch or a complex infographic.
```
